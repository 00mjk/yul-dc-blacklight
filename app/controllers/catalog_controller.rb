...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'score desc, title_ssim asc, oid_ssi desc', label: 'relevance'
    config.add_sort_field 'creator_ssim asc, title_ssim asc, oid_ssi desc', label: 'Creator (A --> Z)'
    config.add_sort_field 'creator_ssim desc, title_ssim asc, oid_ssi desc', label: 'Creator (Z --> A)'
